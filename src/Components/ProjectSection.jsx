            ...
            <section className="main-project">
              ...
              <div className="project-text-content">
                ...
                <div className="pro-links">
                  ...
                  <a href="https://crypto-junky.netlify.app/" target="_blank">
                    Demo
                  </a>
                </div>
              </div>
            ...
            <section className="main-project">
              <div className="project-text-content">
                ...
                <p>
                  ...
                  React-router is used to navigate through pages. The Jobs data
                  is fetched from locally created data file using Axios library.
                ...
                <div className="pro-links">
                  ...
                  <a href="https://jobsearch24-7.netlify.app/" target="_blank">
                    Demo
                  </a>
                </div>
              </div>
